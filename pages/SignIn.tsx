    ...
    <div className="min-h-screen flex items-center justify-center p-6" style={{ backgroundColor: 'var(--bg-color)', color: 'var(--text-color)' }}>
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold font-outfit mb-2">Welcome Back</h2>
          <p className="text-sm opacity-60">Sign in to continue your journey</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm opacity-60">
            ...
            <Link to="/signup" className="text-cyan-400 hover:text-cyan-300 font-bold">
              Sign Up
            </Link>
          </p>
        </div>
